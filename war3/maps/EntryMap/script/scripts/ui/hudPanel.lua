...
function hudPanel:initLogic()
    -- self.uiLogic:bind_unit_attr('头像.属性.攻击速度.文本', '文本', '攻击速度')
    -- self.uiLogic:bind_unit_attr('头像.属性.移动速度.文本', '文本', '移动速度')
    -- self.uiLogic:bind_unit_attr('血条.进度条', '当前值', '生命')
    -- self.uiLogic:bind_unit_attr('血条.进度条', '最大值', '最大生命')
    -- self.uiLogic:bind_unit_attr('血条.文本.当前值', '文本', '生命')
    -- self.uiLogic:bind_unit_attr('血条.文本.最大值', '文本', '最大生命')
    -- self.uiLogic:bind_unit_attr('蓝条.进度条', '当前值', '魔法')
    -- self.uiLogic:bind_unit_attr('蓝条.进度条', '最大值', '最大魔法')
    -- self.uiLogic:bind_unit_attr('蓝条.文本.当前值', '文本', '魔法')
    -- self.uiLogic:bind_unit_attr('蓝条.文本.最大值', '文本', '最大魔法')
    -- self.uiLogic:bind_unit_attr('属性栏.攻击.文本', '文本', '物理攻击')
    -- self.uiLogic:bind_unit_attr('属性栏.防御.文本', '文本', '物理防御')
    -- self.uiLogic:bind_unit_attr('属性栏.力量.文本', '文本', '力量')
    -- self.uiLogic:bind_unit_attr('属性栏.敏捷.文本', '文本', '敏捷')
    -- self.uiLogic:bind_unit_attr('属性栏.智力.文本', '文本', '智力')
    ...
    -- self.uiLogic:on_refresh('头像.图片', function(ui, local_player)
    ...
    -- self.uiLogic:on_refresh('头像.名字.文本', function(ui, local_player)
    --     if not local_player:get_selecting_unit() then
    --         return
    --     end
    ...
    -- self.uiLogic:on_refresh('英雄技能', function(ui, local_player)
    --     if not local_player:get_selecting_unit() then
    --         return
    --     end
    ...
    -- self.uiLogic:on_refresh('经验条.进度条', function(ui, local_player)
    --     if not local_player:get_selecting_unit() then
    --         return
    --     end
    ...
    -- self.uiLogic:on_refresh('经验条.经验文本', function(ui, local_player)
    --     if not local_player:get_selecting_unit() then
    --         return
    --     end
    ...
    -- self.uiLogic:on_refresh('经验条.等级文本', function(ui, local_player)
    --     if not local_player:get_selecting_unit() then
    --         return
    --     end
    ...
    -- self.uiLogic:on_event('头像', '左键-按下', function(ui, local_player)
    ...
    -- self.uiLogic:on_event('头像', '左键-抬起', function(ui, local_player)
    ...
    -- self.uiLogic:on_refresh('道具', function(ui, local_player)
    --     local u = local_player:get_selecting_unit()
    --     if not u then
    --         return
    --     end
    ...
    --     self.uiLogic:refresh('道具', data.unit:get_owner_player())
    -- end)
end
